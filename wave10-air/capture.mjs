...
const afterDir = path.join(root, 'wave10-air/evidence/after');
const beforeDir = path.join(root, 'wave10-air/evidence/before');
...
const BEFORES = [
  ['wave6/evidence/after/desktop-day.png', 'desktop-day.png'],
  ['wave6/evidence/after/desktop-night.png', 'desktop-night.png'],
  ['wave8-ui/evidence/after/desktop-1280.png', 'desktop-1280.png'],
  ['wave6/evidence/after/deer-shoulder.png', 'deer-shoulder.png'],
  ['wave8-ui/evidence/after/phone-390.png', 'phone-390.png'],
];
